...
@Table(name = "o2md_freight_tpl_detail")
public class FreightTemplateDetail extends AuditDomain {
    ...
    private void validate() {
        Assert.notNull(this.firstPieceWeight, FreightConstants.ErrorCode.BASIC_DATA_FREIGHT_DETAIL_FIRST_PIECE_WEIGHT_IS_NULL);
        Assert.notNull(this.firstPrice, FreightConstants.ErrorCode.BASIC_DATA_FREIGHT_DETAIL_FIRST_PRICE_IS_NULL);
        Assert.notNull(this.nextPieceWeight, FreightConstants.ErrorCode.BASIC_DATA_FREIGHT_DETAIL_NEXT_PIECE_WEIGHT_IS_NULL);
        Assert.notNull(this.nextPrice, FreightConstants.ErrorCode.BASIC_DATA_FREIGHT_DETAIL_NEXT_PRICE_IS_NULL);
        Assert.notNull(this.templateId, FreightConstants.ErrorCode.BASIC_DATA_FREIGHT_DETAIL_TEMPLATE_ID_IS_NULL);
    }
