...
public class CountryRepositoryImpl extends BaseRepositoryImpl<Country> implements CountryRepository {
    ...
    public List<Country> listCountryLov(CountryQueryLovDTO regionQueryLov, Long tenantId) {
        ...
        List<Map<String,Object>> list = lovAdapter.queryLovData(RegionConstants.RegionLov.LOV_CODE.getCode(),tenantId, null,  regionQueryLov.getPage(), regionQueryLov.getSize() , queryParams);
        if (list.isEmpty()){
            return countryList;
        }
