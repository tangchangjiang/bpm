...
public class SystemParameterSiteController extends BaseController {
    ...
    @ProcessLovValue(targetField = {BaseConstants.FIELD_BODY})
    @PostMapping("/copy")
    public ResponseEntity<BatchOperateResponse> copySysParam(@RequestBody SysParamCopyDTO copyDTO) {
        return Results.success(sysParamService.copySysParamOfSite(copyDTO.getParamId(), copyDTO.getTenantIds()));
    }
}
