...
@Api(tags = MetadataManagementAutoConfiguration.CURRENCY)
@Controller("currencyController.v1")
...
public class CurrencyController extends BaseController {
    ...
    public ResponseEntity<Page<CurrencyVO>> page(@PathVariable Long organizationId,
                                                 CurrencyDTO currencyDTO,
                                                 PageRequest pageRequest) {
        currencyDTO.setTenantId(organizationId);
