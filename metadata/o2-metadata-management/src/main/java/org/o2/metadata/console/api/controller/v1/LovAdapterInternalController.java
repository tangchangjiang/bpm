...
public class LovAdapterInternalController {
    ...
    public ResponseEntity<Map<String, CurrencyBO>> findCurrencyByCodes(@PathVariable(value = "organizationId") @ApiParam(value = "租户ID", required =
    ...
    public ResponseEntity<Map<String, UomTypeBO>> findUomTypeByCodes(@PathVariable(value = "organizationId") @ApiParam(value = "租户ID", required =
            true) Long organizationId,
    ...
    public ResponseEntity<List<Map<String, Object>>> batchQueryLovValueMeaning(@PathVariable(value = "organizationId") @ApiParam(value = "租户ID",
