...
public interface NeighboringRegionService {
     ...
     * @return 查询结果集
     */
    List<NeighboringRegion> findNeighboringRegions(NeighboringRegionQueryDTO neighboringRegion);
     ...
     * @return  查询结果集
     */
    List<NeighboringRegionCO> listNeighboringRegions(Long organizationId);
}
