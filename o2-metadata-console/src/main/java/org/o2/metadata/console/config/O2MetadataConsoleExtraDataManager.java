 ...
 */
@ChoerodonExtraData
public class O2MetadataConsoleExtraDataManager implements ExtraDataManager {
    private final O2RouteProperties o2RouteProperties;

    public O2MetadataConsoleExtraDataManager(O2RouteProperties o2RouteProperties) {
