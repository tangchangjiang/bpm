...
public class BizParamUtil {
        ...
        try{
            ...
            paramDefinitionMap = CollectionCacheHelper.getCache(BusinessProcessConstants.CacheParam.CACHE_NAME,
                    ...
                    Collections.singletonList(paramCode), paramCodes ->{
                        BizNodeParameterDO bizNodeParameterDO = ResponseUtils.getResponse(pipelineRemoteService.getParamDefinition(tenantId, beanId, paramCode), BizNodeParameterDO.class);
            ...
            BusinessProcessRuntimeException processException = new BusinessProcessRuntimeException(BusinessProcessConstants.ErrorMessage.PIPELINE_NETWORK_REQUEST_ERROR, beanId);
    ...
    protected static Object doParsing(String beanId, String paramCode, Object paramValue, BizNodeParameterDO parameterDO) {
        ...
        try{
            ...
            BusinessProcessRuntimeException processException = new BusinessProcessRuntimeException(BusinessProcessConstants.ErrorMessage.PARAM_PARSING_ERROR, beanId, paramCode, JsonHelper.objectToString(paramValue));
            processException.setStackTrace(e.getStackTrace());
            throw processException;
        }
        return result;
