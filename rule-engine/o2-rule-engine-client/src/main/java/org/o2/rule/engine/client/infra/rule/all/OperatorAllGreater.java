 ...
 */
public class OperatorAllGreater extends AbstractCollectionOperator {

    /**
     * 构造函数
     * @param aName 名称
     */
    public OperatorAllGreater(String aName) {
        this.name = aName;
    }
    ...
    public Object executeInner(Object[] list) throws Exception {
        ...
        return collectionCompare(list, RuleClientConstants.CollectionOperator.ALL, RuleClientConstants.Operator.GREATER);
    }
