 ...
 */
public class OperatorAllLessOrEqual extends AbstractCollectionOperator {

    /**
     * 构造函数
     * @param aName 名称
     */
    public OperatorAllLessOrEqual(String aName) {
        this.name = aName;
    }
    ...
    public Object executeInner(Object[] list) throws Exception {
        ...
        return collectionCompare(list, RuleClientConstants.CollectionOperator.ALL, RuleClientConstants.Operator.LESS_OR_EQUAL);
    }
