 ...
 */
public class OperatorAnyLess extends AbstractCollectionOperator {

    /**
     * 构造函数
     * @param aName 名称
     */
    public OperatorAnyLess(String aName) {
        this.name = aName;
    }
    ...
    public Object executeInner(Object[] list) throws Exception {
        ...
        return collectionCompare(list, RuleClientConstants.CollectionOperator.ANY, RuleClientConstants.Operator.LESS);
    }
