...
public class O2RuleManagementRemoteServiceImpl implements O2RuleManagementRemoteService {
    ...
    @Override
    public ResponseEntity<String> useRule(Long organizationId, List<Long> ruleIds) {
        log.error("Use Rules Error, organizationId:[{}], ruleIds:[{}]", organizationId, JsonHelper.objectToString(ruleIds));
